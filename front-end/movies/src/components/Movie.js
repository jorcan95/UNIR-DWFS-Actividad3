...
/*
    ...
    const imageBodyTemplate = (rowData) => {
        return <img src={`${rowData.poster}`} alt={rowData.image} className="shadow-2 border-round" style={{ width: '64px' }} />;
    };
/*
        ...
        <div>
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={movies} selection={selectedMovies} onSelectionChange={(e) => setSelectedMovies(e.value)}
                    ...
                    <Column field="director" header="Director" sortable style={{ minWidth: '16rem' }}></Column>
                    <Column field="premiereYear" header="Año" sortable style={{ minWidth: '16rem' }}></Column>
                    <Column field="genre" header="Genero" sortable style={{ minWidth: '10rem' }}></Column>

                    <Column field="actors" header="Actores" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="duration" header="Duración" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="language" header="Lenguaje" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="country" header="País" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="productionCompany" header="Compañia" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="rating" header="Clasificación" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="ratingValue" header="Calificación" body={ratingBodyTemplate} sortable style={{ minWidth: '12rem' }}></Column>
            ...
            <Dialog visible={movieDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Movie Details" modal className="p-fluid" footer={movieDialogFooter} onHide={hideDialog}>
                {movie.image && <img src={`${movie.poster}`} style={{ width: '100%' }} alt={movie.image} className="movie-image block m-auto pb-3" />}
                <div className="field">
            ...
            <Dialog visible={deleteMovieDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Confirmación" modal footer={deleteMovieDialogFooter} onHide={hideDeleteMovieDialog}>
            ...
            <Dialog visible={deleteMoviesDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Confirmación" modal footer={deleteMoviesDialogFooter} onHide={hideDeleteMoviesDialog}>
                <div className="confirmation-content">
                    <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
